...
chatMessageRouter.post('/', (0, celebrate_1.celebrate)((_a = {},
...
chatMessageRouter.get('/:id', (0, celebrate_1.celebrate)((_b = {},
    _b[celebrate_1.Segments.PARAMS] = {
        id: celebrate_1.Joi.string().uuid().required()
    },
    _b)), chatMessageController.fetchBy);
chatMessageRouter.put('/:id', (0, celebrate_1.celebrate)((_c = {},
    _c[celebrate_1.Segments.PARAMS] = {
        id: celebrate_1.Joi.string().uuid().required()
    },
    _c)), chatMessageController.update);
chatMessageRouter.delete('/:id', (0, celebrate_1.celebrate)((_d = {},
