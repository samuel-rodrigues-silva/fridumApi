...
var ServiceRepository = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, (Number(countingFollow[1])).toString()];
                }
            });
        });
    };
    ServiceRepository.prototype.findById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.ormRepository.find({ where: { user: id }, relations: ['user', 'user.profile', 'post', 'follow', 'follow.profile'] })];
    ...
    ServiceRepository.prototype.findByFollowId = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.ormRepository.find({ where: { follow: id }, relations: ['user', 'user.profile', 'post', 'follow', 'follow.profile'] })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
