...
var ShowUnreadServiceService_1 = __importDefault(require("../../../services/ShowUnreadServiceService"));
var ServiceController = /** @class */ (function () {
    ...
    ServiceController.prototype.fetchUnreadServices = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id, service, res, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = request.params.id;
                        service = tsyringe_1.container.resolve(ShowUnreadServiceService_1.default);
                        return [4 /*yield*/, service.execute(id)];
                    case 1:
                        res = _a.sent();
    ...
    ServiceController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var createService, service, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
