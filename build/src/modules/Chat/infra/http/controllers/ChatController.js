...
var ChatController = /** @class */ (function () {
    ...
    ChatController.prototype.show = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id, showChat, chat, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = request.params.id;
                        showChat = tsyringe_1.container.resolve(ShowChatService_1.default);
                        return [4 /*yield*/, showChat.execute(id)];
                    case 1:
                        chat = _a.sent();
    ...
    ChatController.prototype.remove = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id, repo, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = request.params.id;
                        repo = tsyringe_1.container.resolve(DeleteChatService_1.default);
