...
var Language_1 = require("./../entities/Language");
...
var LanguageRepository = /** @class */ (function () {
    function LanguageRepository() {
        this.ormRepository = (0, typeorm_1.getRepository)(Language_1.Language);
        this.profileRepository = (0, typeorm_1.getRepository)(Profile_1.Profile);
    }
    LanguageRepository.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var profile, Language;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.profileRepository.findOne({ where: { id: data.profileId } })];
                    case 1:
                        profile = _a.sent();
                        Language = this.ormRepository.create(data);
                        Language.profile = profile;
                        return [4 /*yield*/, this.ormRepository.save(Language)];
                    case 2:
                        _a.sent();
    ...
    LanguageRepository.prototype.update = function (data, LanguageId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    LanguageRepository.prototype.delete = function (LanguageId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.ormRepository.delete(LanguageId)];
