...
var Starred_1 = require("./../entities/Starred");
...
var StarredRepository = /** @class */ (function () {
    ...
    StarredRepository.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var user, post, starred, StarredReg;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        post = _a.sent();
                        return [4 /*yield*/, this.ormRepository.findOne({ where: { user: user, post: post } })];
                    case 3:
                        starred = _a.sent();
                        if (!!starred) return [3 /*break*/, 5];
                        StarredReg = this.ormRepository.create();
                        StarredReg.user = user;
                        StarredReg.post = post;
                        return [4 /*yield*/, this.ormRepository.save(StarredReg)];
    ...
    StarredRepository.prototype.delete = function (StarredId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
...
exports.default = StarredRepository;
//# sourceMappingURL=StarredRepository.js.map