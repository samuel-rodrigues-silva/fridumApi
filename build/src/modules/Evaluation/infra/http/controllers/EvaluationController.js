...
var CreateEvaluationService_1 = __importDefault(require("./../../../services/CreateEvaluationService"));
...
var EvaluationController = /** @class */ (function () {
    ...
    EvaluationController.prototype.update = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id, repo, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = request.params.id;
                        repo = tsyringe_1.container.resolve(UpdateEvaluationService_1.default);
    ...
    EvaluationController.prototype.remove = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = request.params.id;
                        repo = tsyringe_1.container.resolve(DeleteEvaluationService_1.default);
