...
var sessionRouter = (0, express_1.Router)();
sessionRouter.get('/:id', (0, celebrate_1.celebrate)((_a = {},
    _a[celebrate_1.Segments.PARAMS] = {
        id: celebrate_1.Joi.string().uuid().required()
    },
    _a)), verifyAuth_1.default, sessionController.fetchBy);
sessionRouter.post('/verify', (0, celebrate_1.celebrate)((_b = {},
    _b[celebrate_1.Segments.BODY] = {
        email: celebrate_1.Joi.string().email().required()
    },
    _b)), sessionController.fetchByEmail);
sessionRouter.post('/', (0, celebrate_1.celebrate)((_c = {},
...
sessionRouter.post('/auth', (0, celebrate_1.celebrate)((_d = {},
    _d[celebrate_1.Segments.BODY] = {
        email: celebrate_1.Joi.string().email().required(),
        password: celebrate_1.Joi.string().required()
    },
    _d)), sessionController.auth);
sessionRouter.patch('/:id', (0, celebrate_1.celebrate)((_e = {},
...
sessionRouter.delete('/:id', (0, celebrate_1.celebrate)((_f = {},
