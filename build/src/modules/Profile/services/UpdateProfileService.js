...
var UpdateProfileService = /** @class */ (function () {
    function UpdateProfileService(profileRepository) {
        this.profileRepository = profileRepository;
    }
    UpdateProfileService.prototype.execute = function (data, id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.profileRepository.update(data, id)];
