...
var DeleteFollowService = /** @class */ (function () {
    function DeleteFollowService(followRepository) {
        this.followRepository = followRepository;
    }
    DeleteFollowService.prototype.execute = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.followRepository.delete(id)];
...
//# sourceMappingURL=DeleteFollowService.js.map