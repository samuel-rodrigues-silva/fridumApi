...
var FollowController = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        createFollow = tsyringe_1.container.resolve(CreateFollowService_1.default);
                        return [4 /*yield*/, createFollow.execute(request.body)];
                    case 1:
                        follow = _a.sent();
                        return [2 /*return*/, response.json(class_transformer_1.classToClass(follow))];
                    case 2:
                        err_1 = _a.sent();
    ...
    FollowController.prototype.remove = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id, repo, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        repo = tsyringe_1.container.resolve(DeleteFollowService_1.default);
