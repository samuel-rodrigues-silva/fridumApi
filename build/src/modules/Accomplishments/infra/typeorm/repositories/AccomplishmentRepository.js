...
var Accomplishment_1 = require("./../entities/Accomplishment");
var Profile_1 = require("./../../../../Profile/infra/typeorm/entities/Profile");
var AccomplishmentRepository = /** @class */ (function () {
    function AccomplishmentRepository() {
        this.ormRepository = (0, typeorm_1.getRepository)(Accomplishment_1.Accomplishment);
    ...
    AccomplishmentRepository.prototype.delete = function (accomplishmentId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
...
exports.default = AccomplishmentRepository;
//# sourceMappingURL=AccomplishmentRepository.js.map