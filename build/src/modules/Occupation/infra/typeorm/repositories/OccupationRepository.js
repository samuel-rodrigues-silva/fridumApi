...
var Occupation_1 = require("./../entities/Occupation");
...
var OccupationRepository = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        profile = _a.sent();
                        Occupation = this.ormRepository.create(data);
    ...
    OccupationRepository.prototype.update = function (data, OccupationId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    OccupationRepository.prototype.delete = function (OccupationId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.ormRepository.delete(OccupationId)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
...
//# sourceMappingURL=OccupationRepository.js.map