...
var FocusArea_1 = require("./../entities/FocusArea");
...
var FocusAreaRepository = /** @class */ (function () {
    ...
    FocusAreaRepository.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var profile, focusArea;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.profileRepository.findOne({ where: { id: data.profileId } })];
                    case 1:
                        profile = _a.sent();
                        focusArea = this.ormRepository.create(data);
                        focusArea.profile = profile;
                        return [4 /*yield*/, this.ormRepository.save(focusArea)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, focusArea];
                }
            });
        });
    };
    FocusAreaRepository.prototype.update = function (data, focusAreaId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    FocusAreaRepository.prototype.delete = function (focusAreaId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.ormRepository.delete(focusAreaId)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
...
exports.default = FocusAreaRepository;
